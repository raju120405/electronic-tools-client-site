    ...
    <div class="drawer drawer-mobile">
      ...
      <div class="drawer-side">
        ...
        <ul class="menu p-4 overflow-y-auto w-80 bg-base-100 text-base-content">
          ...
          {admin && <li><Link to={'/deshboard/addproduct'}>Add a product</Link></li>}
          {admin && <li><Link to={'/deshboard/menageproduct'}>Menage All Orders</Link></li>}
          <li><Link to={'/deshboard/order'}>My Order</Link></li>
          <li><Link to={'/deshboard/profile'}>My Profile</Link></li>
        </ul>
